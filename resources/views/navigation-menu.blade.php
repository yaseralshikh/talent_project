        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="flex items-center flex-shrink-0">
                    <a href="{{ route('home') }}">
                        <div>
                            <img class="block w-auto text-gray-100 h-9" src="{{ asset('images/logo.png') }}">
                        </div>
                        <a href="/" class="text-sm font-semibold tracking-widest text-white uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">وحدة الموهوبين ( وسط جازان )</a>
                    </a>
                </div>
            </div>
